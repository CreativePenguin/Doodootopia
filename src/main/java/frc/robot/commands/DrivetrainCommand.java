...
public abstract class DrivetrainCommand extends Command {
    ...
    public static class Controller {
        public static double getTriggers() {
            ...
            mSpeed = Math.pow(Robot.oi.driverGamepad.getRawRightTriggerAxis(), Drivetrain.Command.Controls.TRIGGER_SCALAR);
            mSpeed -= Math.pow(Robot.oi.driverGamepad.getRawLeftTriggerAxis(), Drivetrain.Command.Controls.TRIGGER_SCALAR);
        ...
        public static double getJoystick() {
            ...
            leftStick = Math.pow(leftStick, Drivetrain.Command.Controls.JOYSTICK_SCALAR);
