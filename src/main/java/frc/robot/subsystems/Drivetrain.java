...
public final class Drivetrain extends Subsystem {
    ...
    public Drivetrain() {
        // Left Side Motors
        highLeftTopMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.LEFT_TOP_MOTOR, MotorType.kBrushless);
        highLeftMiddleMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.LEFT_MIDDLE_MOTOR, MotorType.kBrushless);
        lowLeftTopMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.LEFT_TOP_MOTOR, MotorType.kBrushless);
        lowLeftMiddleMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.LEFT_MIDDLE_MOTOR, MotorType.kBrushless);
        leftBottomMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.LEFT_BOTTOM_MOTOR, MotorType.kBrushless);

        // Right Side Motors
        highRightTopMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.RIGHT_TOP_MOTOR, MotorType.kBrushless);
        highRightMiddleMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.RIGHT_MIDDLE_MOTOR, MotorType.kBrushless);
        lowRightTopMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.RIGHT_TOP_MOTOR, MotorType.kBrushless);
        lowRightMiddleMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.RIGHT_MIDDLE_MOTOR, MotorType.kBrushless);
        rightBottomMotor = new CANSparkMax(RobotMap.Drivetrain.Ports.RIGHT_BOTTOM_MOTOR, MotorType.kBrushless);
        ...
        // Greyhill Encoders
        leftGreyhill = new Encoder(RobotMap.Drivetrain.Encoder.LEFT_CHANNEL_A, RobotMap.Drivetrain.Encoder.LEFT_CHANNEL_B);
        rightGreyhill = new Encoder(RobotMap.Drivetrain.Encoder.RIGHT_CHANNEL_A, RobotMap.Drivetrain.Encoder.RIGHT_CHANNEL_B);
    
        leftGreyhill.setDistancePerPulse(RobotMap.Drivetrain.Greyhill.INCHES_PER_PULSE);
        rightGreyhill.setDistancePerPulse(-1.0 * RobotMap.Drivetrain.Greyhill.INCHES_PER_PULSE);
        ...
        highRightTopMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        highRightMiddleMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        lowRightTopMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        lowRightMiddleMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        rightBottomMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        
        highLeftTopMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        highLeftMiddleMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        lowLeftTopMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        lowLeftMiddleMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        leftBottomMotor.setSmartCurrentLimit(RobotMap.Drivetrain.Greyhill.CURRENT_LIMIT);
        ...
        //Gear Shift
        gearShift = new Solenoid(RobotMap.Drivetrain.Ports.GEAR_SHIFT);
        // navx
    ...
    private double getLeftNEODistance() {
        return getLeftNEOEncoderTicks() * RobotMap.Motor.NEO_ENCODER_RAW_MULTIPLIER;
    }

    private double getRightNEODistance() {
        return getRightNEOEncoderTicks() * RobotMap.Motor.NEO_ENCODER_RAW_MULTIPLIER;
    }
    ...
    public void enableRamping() {
        highRightTopMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        highRightMiddleMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        lowRightTopMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        lowRightMiddleMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        rightBottomMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        
        highLeftTopMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        highLeftMiddleMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        lowLeftTopMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        lowLeftMiddleMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
        leftBottomMotor.setOpenLoopRampRate(RobotMap.Drivetrain.Motor.RAMP_RATE);
    }
